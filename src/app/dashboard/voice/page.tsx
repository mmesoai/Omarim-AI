...
import { Mic, Square, Loader2, Bot, BrainCircuit, Waves } from "lucide-react";
...
export default function VoicePage() {
  ...
  return (
    <div className="container mx-auto max-w-2xl space-y-6">
      <div>
        <h2 className="text-2xl font-headline font-semibold">Voice Command Center</h2>
        <p className="text-muted-foreground">
          Speak your commands directly to Omarim AI.
        </p>
      </div>
      ...
      <Card className="flex flex-col">
        ...
        <CardContent className="flex flex-grow flex-col items-center justify-center space-y-4 text-center py-10">
          <Button
            size="lg"
