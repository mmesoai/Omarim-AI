...
export const mails: Mail[] = [
  ...
  },
  {
    ...
    text: "Hi there,\n\nI love using OmarimAI. One thing that I think could be improved is the dashboard loading speed. Sometimes it feels a bit sluggish. Just a thought!\n\nBest,\nAva",
