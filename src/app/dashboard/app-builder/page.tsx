          ...
          <CardContent className="mt-6 space-y-6">
            ...
            <Section icon={Layers} title="Technology Stack">
                <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                    <div className="text-center"><p className="font-semibold">Frontend</p><p className="text-sm text-muted-foreground">{blueprint.techStack.frontend}</p></div>
                    <div className="text-center"><p className="font-semibold">Backend</p><p className="text-sm text-muted-foreground">{blueprint.techStack.backend}</p></div>
                     <div className="text-center"><p className="font-semibold">Database</p><p className="text-sm text-muted-foreground">{blueprint.techStack.database}</p></div>
                     <div className="text-center"><p className="font-semibold">AI/ML</p><p className="text-sm text-muted-foreground">{blueprint.techStack.ai}</p></div>
                </div>
            </Section>
          </CardContent>
        </Card>
